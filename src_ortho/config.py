...
SMPL_FACE_PATH = osp.join(curr_path, '../src_ortho/tf_smpl', 'smpl_faces.npy')

# Default pred-trained model path for the demo.
PRETRAINED_MODEL = osp.join(model_dir, 'model.ckpt-55124')
...
flags.DEFINE_string('pretrained_model_path', PRETRAINED_MODEL,#None, #
...
DATA_DIR = '/scratch1/williamljb/hmr_multiview/tf_datasets/'
...
flags.DEFINE_list('datasets', ['coco','h36m','mpi_inf_3dhp', 'synthetic'],
                          'datasets to use for training')
flags.DEFINE_list('mocap_datasets', [],
...
flags.DEFINE_float('d_lr', 1e-5, 'Adversarial prior learning rate')
...
flags.DEFINE_float('e_pose_weight', 1, 'weight on E_3d')
flags.DEFINE_float('e_shape_weight', 1, 'weight on E_3d')
